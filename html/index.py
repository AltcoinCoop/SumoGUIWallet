    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="col-xs-6" style="text-align:right">
                                <h5><span id="balance">0.000000000000</span> <small>Mynt</small> <span class="syncing"> (syncing)</span></h5>
                                <h5><span id="unlocked_balance">0.000000000000</span> <small>Mynt</small> <span class="syncing"> (syncing)</span></h5>
                            </div>
        ...
        <script id="recent_tx_row_templ" type="x-tmpl-mustache">
            <div class="col-sm-12">
                <div class="col-xs-10" style="padding-right:0">
                    <p class="tx-list tx-{{cls_in_out}}"><i class="fa fa-{{ tx_fa_icon }}"></i> ({{tx_direction}}) <span class="tx-list txid"><a href="javascript:open_link('https://explorer.myntpulse.com/txid/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span></p>
        ...
        <script id="tx_detail_templ" type="x-tmpl-mustache">
            <p class="tx-list tx-{{cls_in_out}}" style="font-size: 90%"><i class="fa fa-{{ tx_fa_icon }}"></i> {{tx_direction}}<br>
                <span class="tx-list txid"><a href="javascript:open_link('https://explorer.myntpulse.com/txid/{{ tx_id }}')" title="View on blockchain explorer">{{ tx_id }}</a></span>
            </p>
